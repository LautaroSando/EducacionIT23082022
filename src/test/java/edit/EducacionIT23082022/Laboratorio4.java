...
public class Laboratorio4 {
	...
	public void registrarUsuario() {
		...
		txtEmail.sendKeys("micorreo"+Math.random() + "@correo.com");// cambiar el mail porque cuando se registra ya no te deja usar el mismo
		...
		driver.findElement(By.cssSelector("#postcode")).sendKeys("25451");
